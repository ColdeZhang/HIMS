...
void run(const oatpp::base::CommandLineArguments& args) {
  ...
  /* 添加路由 */
  auto patientController = router->addController(PatientController::createShared());
  auto staticController = router->addController(StaticController::createShared());

  oatpp::web::server::api::Endpoints docEndpoints;
  docEndpoints.append(patientController->getEndpoints());
